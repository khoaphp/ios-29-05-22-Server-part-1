...
$(document).ready(function(){
    ...
    $("#btnCheck").click(function(){
        ...
        smFund_Contract.methods.balanceOf(address).call().then((data)=>{
            $("#txt").html(web3.utils.hexToNumberString(data));
        });
    });
